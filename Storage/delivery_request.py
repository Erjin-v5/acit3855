...
class DeliveryRequest(Base):
    ...
    def __init__(self, customer_name, device_id, driver_id, item, quantity, order_id, store_id, timestamp):
        """ Initializes a delivery request reading """
    ...
    def to_dict(self):
        """ Dictionary Representation of a delivery request reading """
